...
const FlightRoutes = () => {
  ...
  return (
    <div className="px-6 py-12 text-center">
      <h2 className="text-3xl font-bold text-gray-900 mb-2">Explore Flight Routes</h2>
      ...
      <div className="flex justify-center gap-4 mb-8">
        {['Domestic', 'International'].map(tab => (
          <button
            ...
            className={`px-6 py-2 rounded font-medium transition-all duration-200 text-sm md:text-base
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto hover:cursor-pointer">
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-500 text-sm truncate w-40">{route.fromAirport}</p>
              </div>
              <Plane className="text-[#FF204E] mx-2" size={20} />
              <div>
                <h3 className="font-semibold text-lg">{route.to}</h3>
                <p className="text-gray-500 text-sm truncate w-40">{route.toAirport}</p>
              </div>
            </div>
          </div>
        ))}
